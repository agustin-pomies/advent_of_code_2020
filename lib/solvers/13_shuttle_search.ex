defmodule ShuttleSearch do
  ...
  def get_data_2 do
    ...
    |> Enum.map(fn {frequency, index} -> {frequency, if(index != 0, do: frequency - index, else: 0)} end)
  ...
  def chinese_reminder_theorem([{module_1, reminder_1} | [{module_2, reminder_2} | tail]] = list) when length(list) >= 2 do
