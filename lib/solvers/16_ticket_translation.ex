defmodule TicketTranslation do
  def get_data do
    [field_rules_string, my_ticket_string, nearby_tickets_string | _] =
      IOModule.get_input(16, "\n\n")
  ...
  def deduce_fields(columns, field_rules, not_assigned_fields, assigned_fields) do
    ...
    if is_candidate_rule?(values_to_match, rule) do
      ...
      case deduce_fields(
             values,
             updated_not_assigned_fields |> Map.to_list(),
             updated_not_assigned_fields,
             updated_assigned_fields
           ) do
