defmodule CrabCups do
  ...
  def find_destination_cup({picked_up_cups, remaining_cups}, current_cup, 0, total_cups), do: find_destination_cup({picked_up_cups, remaining_cups}, current_cup, total_cups, total_cups)
  def find_destination_cup({picked_up_cups, remaining_cups}, current_cup, destination_cup, total_cups) do
    ...
    if destination_cup_index do
      ...
      find_destination_cup({picked_up_cups, remaining_cups}, current_cup, destination_cup - 1, total_cups)
    end
  end
  ...
  def find_destination_cup_2_0(possible_destination, next_cups, total_cups) do
    cond do
      (possible_destination < 1)           -> find_destination_cup_2_0(total_cups, next_cups, total_cups)
      (possible_destination in next_cups)  -> find_destination_cup_2_0(possible_destination - 1, next_cups, total_cups)
      true                                 -> possible_destination
    end
  end
